...
// Function declaration for the applyBrightness function, which adjusts the brightness of an image.
// Takes a 2D vector of Pixel objects as input and modifies it based on the specified brightness amount.
